        ...
        <form noValidate onSubmit={handleSubmit} className="overflow-y-auto flex-1 py-4 space-y-4 pr-1">
          ...
          <div>
            ...
            <input
              id="fund-name"
              type="text"
              placeholder="e.g. Solar Roof Expansion, Meditation Hall Restoration"
              value={name}
          ...
          <div>
            ...
            <textarea
              id="fund-description"
              rows={3}
              placeholder="e.g. Installing clean solar panels over the meditation hall to power sanctuary lights and protect the environment..."
              value={description}
          ...
          <div className="p-3 rounded-xl bg-amber-50/70 border border-amber-200/80 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <label htmlFor="fund-verified" className="text-xs font-semibold text-stone-800 cursor-pointer">
